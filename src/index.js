...
class Board extends React.Component {
    ...
    renderSquare(i) {
        return (
            <button onClick={() => this.hanldeBoxClick(i)}> {this.props.boxes[i] == null ? "" : this.props.boxes[i]}</button>
        )
    }
    ...
    render() {
        ...
        return (
            <>
                ...
                <Display stepNumber={this.state.stepNumber} handlerForHistory={(i) => this.moveToStep(i)} gameStatus={this.state.gameStatus} />
            </>
        )
    }
}
